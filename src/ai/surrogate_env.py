    ...
    def step(self, actions: dict[str, int]
        ...
        for i, tid in enumerate(self.tls_ids):
            ...
            if abs(o[MAX_INCOMING_EDGES * 3] - prev_phase) > 0.01:
                ...
                o[MAX_INCOMING_EDGES * 3 + 1] = min(elapsed + self.delta_time / 60.0, 1.0)

            # Feature 38: min_green flag
            elapsed_val = o[MAX_INCOMING_EDGES * 3 + 1] * 60.0
            o[MAX_INCOMING_EDGES * 3 + 2] = 1.0 if elapsed_val >= 5 else 0.0
